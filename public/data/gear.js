    ...
    items: [
      {
        ...
        blurb: "For the avid adventurer who needs frames that hold up to the moisture of the underground and the high winds of the summit \u2014 comfortable, durable, and forgettable in the best way.",
        details: [
    ...
    items: [
      {
        ...
        blurb: "We found the best way to match consistency and utility during our travels with YETI. From coffee before hitting the trail to staying hydrated on steep ascents, the Rambler lineup covers every leg of the day.",
        details: [
    ...
    items: [
      {
        ...
        imageAlt: "A scuffed Stanley classic 48 oz French press on a camp table.",
        blurb: "Don't let its beat-up appearance fool you. Coffee is the first task of any successful day of outdoor exploration, and the Stanley French Press has come to our rescue to simplify the morning routine.",
        details: [
    ...
    items: [
      {
        ...
        blurb: "Tents are so overrated. Poles, footprints, rain fly, stakes \u2014 give yourself a break. The OneLink system from ENO is lightweight, easy to pack, and rocks you to sleep off the ground.",
        details: [
    ...
    items: [
      {
        ...
        blurb: "This handheld GPS gives us the best of both worlds. A large touch display improves trail planning and tracking accuracy, and with the suction mount it doubles as a basic automotive navigator.",
        details: [
      ...
      },
      {
        ...
        blurb: "A rugged GPS smartwatch that tracks trails as easily as it tracks sleep \u2014 our everyday piece on and off the trail.",
        details: [
...
const gearDisclosure = "Some links on this page are affiliate links. If you click through and buy something we recommend, Open Atlas may earn a small commission at no extra cost to you. We only recommend gear we actually carry and use on the trail.";
export {
  gearCategories,
  gearDisclosure
};
