...
export const planningKit: PlanningKitGroup[] = [
  {
    id: "route-tools",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        name: "November – April",
        kind: "Winter",
        why: "Most high-country roads close. Coast and high desert become the move. Chains are required in the Cascades. Caves stay ~55°F year round.",
      },
    ],
  },
  {
